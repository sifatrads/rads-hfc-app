...
export interface ComplianceSummary {
  ...
  designBasis: {
    ...
    densityGpmFt2?: number; designAreaFt2?: number; dryAreaIncreasePct?: number; operatingSprinklers?: number; designAreaMode?: string;
...
export function buildComplianceSummary(model: ProjectModel, solution: ProjectSolution): ComplianceSummary {
  ...
  return {
    ...
    designBasis: {
      ...
      densityGpmFt2: numOf(db, "densityGpmFt2"), designAreaFt2: s.designAreaFt2 ?? numOf(db, "designAreaFt2"), ...(s.dryAreaIncreasePct ? { dryAreaIncreasePct: s.dryAreaIncreasePct } : {}),
