...
const STANDARD_REFS: Record<string, StandardReference> = {
  ...
  fmds: {
    ...
    clauses: [
      ...
      { topic: "Storage ceiling protection — open-frame rack (min 4 ft aisles), wet, QR pendent", clause: "DS 8-9 Tables 7–10 (verified)" },
      { topic: "Storage in-rack sprinklers / dry / extended-coverage / > 40 ft ceilings", clause: "DS 8-9 (specific table — confirm per project)" },
